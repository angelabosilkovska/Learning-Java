...
public class Glavna {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<n;i++) {
			...
			model1=sc.next();
			System.out.println("Vnesete lagerlista: ");
			lagerlista1=sc.nextInt();
			System.out.println("Vnesete cena: ");
			cena1=sc.nextInt();
			Mobilen m=new Mobilen(marka1,model1,lagerlista1,cena1);
			lista.add(m);
		}
		...
		for(int i=0;i<n;i++) {
			...
			System.out.println(lista.get(i).getLagerLista());
